    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        commonArgs = {
          ...
          # pname and version required, so set dummy values
          pname = "syndicationd-workspace";
          version = "0.1";

          buildInputs = [ ] ++ pkgs.lib.optionals pkgs.stdenv.isDarwin [ pkgs.libiconv pkgs.darwin.apple_sdk.frameworks.Security ];
        };
